...
# 1. 글로벌 증권사 신뢰도 티어 정의
TIER_1_FIRMS = ["GOLDMAN SACHS", "MORGAN STANLEY", "JP MORGAN", "JPMORGAN", "BANK OF AMERICA", "BOFA", "CITIGROUP",
                "BARCLAYS", "UBS", "DEUTSCHE BANK"]
TIER_2_FIRMS = ["WEDBUSH", "NEEDHAM", "PIPER SANDLER", "JEFFERIES", "EVERCORE ISI", "BAIRD", "OPPENHEIMER", "MIZUHO",
                "STIFEL", "COWEN", "BERNSTEIN", "CANTOR FITZGERALD", "RAYMOND JAMES", "WELLS FARGO", "RBC CAPITAL",
                "KEYBANC"]
